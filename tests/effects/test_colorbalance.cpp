...
class TestColorBalance : public GpuTestBase {
    Q_OBJECT
...
private slots:
    ...
    void shadowOffset_biasesDarkPixels() {
        ...
        QVERIFY2(r > g + 40 && r > b + 40, qPrintable(QString("r=%1 g=%2 b=%3").arg(r).arg(g).arg(b)));
        QCOMPARE(g, 20);
        QCOMPARE(b, 20);
    }
    ...
    void highlightOffset_biasesBrightPixels() {
        ...
        QVERIFY2(b > r + 15 && b > g + 15, qPrintable(QString("r=%1 g=%2 b=%3").arg(r).arg(g).arg(b)));
    }
    ...
    void midtoneOffset_biasesMidtones() {
        ...
        int g = pixelG(out, 32, 32);
        int b = pixelB(out, 32, 32);
        QVERIFY2(g > r + 40 && g > b + 40, qPrintable(QString("r=%1 g=%2 b=%3").arg(r).arg(g).arg(b)));
    }
    ...
    void defaultParameters_keysAndValues() {
        ...
        for (const char *k : {"shadowR", "shadowG", "shadowB", "midtoneR", "midtoneG", "midtoneB", "highlightR",
